...
public class UpComingActivity extends AppCompatActivity { RecyclerView rvMovies;
    ...
    private void refresh() {
        ...
        apiService.getUpComingMovie(api_key, language).enqueue(new Callback<ResponseMovies>() {
            ...
            public void onFailure(Call<ResponseMovies> call, Throwable t) {
                loading.dismiss();
                Toast.makeText(getApplicationContext(), "Check your interet connection", Toast.LENGTH_SHORT).show();
            }
        });
    }
